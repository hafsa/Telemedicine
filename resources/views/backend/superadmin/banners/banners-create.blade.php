                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Create Banner  <a href="{{ route('superadmin.bannerlist') }}"><button class="btn btn-outline-light btn-sm px-4 " style="float: right;">- Back</button></a></h4>  
                        </div>
                        <div class="card-body">
                            <form class="form" name="bannerForm" id="bannerForm" method="post" enctype="multipart/form-data" action="{{ route('banner.store') }}">
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="mb-2">
                                            <label for="banner_name" class="mb-2">Banner Name</label>
                                            <input class="form-control" type="text" id="banner_name" name="banner_name" placeholder="Enter Banner Name" value="{{ old('banner_name') }}">
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="mb-2">
                                            ...
                                            <select class="form-select" name="is_fullsize" aria-label="Default select example">
                                                <option value="1" @if(old('is_fullsize') =='1') selected @endif >Full size Banner</option>
                                                <option value="0" @if(old('is_fullsize') =='0') selected @endif>Half size Banner</option>
                                                </select>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="file" id="banner_image" name="banner_image"  value="{{ old('banner_image') }}">
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" id="banner_url" name="banner_url" placeholder="Enter Banner URL" value="{{ old('banner_url') }}">
                                        </div>
