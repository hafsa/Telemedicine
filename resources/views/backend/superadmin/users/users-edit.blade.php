...
@section('title')Edit User Account @endsection
@section('css')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit User Account <a href="{{ route('superadmin.userslist') }}"><button class="btn btn-outline-light btn-sm px-4 " style="float: right;">- Back</button></a></h4>  
                        </div>
                        <div class="card-body">
                            <form class="form" name="userForm" id="userForm" method="POST" enctype="multipart/form-data" action="{{ route('users.update',$user->id) }}">
                                {{ csrf_field() }}
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-control" type="text" id="name" name="name" placeholder="Enter User Name" value="{{ $user->name }}">
                                        </div>
                                        @if ($errors->has('name'))
