...
@section('title') Doctor Dashboard @endsection
@section('css')
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <div class="pt-3">
                                ...
                                <img src=" {{ url('doctor/assets/images/small/business.png') }}" alt="" class="img-fluid px-3 mb-2">
                            </div>
                        </div><!--end card-body--> 
                    </div><!--end card-->                            
                </div> <!--end col-->
                        ...
                        <div class="card-body">
                            <div class="table-responsive browser_users">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        <tr>  
                                            <td><img {{ url('doctor/assets/images/logos/chrome.png') }}" alt="" height="20" class="me-2">Chrome</td> 
                                            <td>10853<small class="text-muted">(52%)</small></td>                                   
                                            <td> 52.80%</td>
                                            <td>566<small class="text-muted">(92%)</small></td>
                                        </tr><!--end tr-->     
                                        <tr>                                                        
                                            <td><img {{ url('doctor/assets/images/logos/micro-edge.png') }}" alt="" height="20" class="me-2">Microsoft Edge</td>
                                            <td>2545<small class="text-muted">(47%)</small></td>                                   
                                            <td> 47.54%</td>
                                            <td>498<small class="text-muted">(81%)</small></td>
                                        </tr><!--end tr-->    
                                        <tr>                                                        
                                            <td><img {{ url('doctor/assets/images/logos/in-explorer.png') }}" alt="" height="20" class="me-2">Internet-Explorer</td>
                                            <td>1836<small class="text-muted">(38%)</small></td>                                   
                                            <td> 41.12%</td>
                                            <td>455<small class="text-muted">(74%)</small></td>
                                        </tr><!--end tr-->    
                                        <tr>                                                        
                                            <td><img {{ url('doctor/assets/images/logos/opera.png') }}" alt="" height="20" class="me-2">Opera</td>
